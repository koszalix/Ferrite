...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        Font panel1Font = this.$$$getFont$$$("JetBrains Mono NL", Font.BOLD, -1, panel1.getFont());
        if (panel1Font != null) panel1.setFont(panel1Font);
        panel1.setRequestFocusEnabled(false);
        tabbedPane_Main = new JTabbedPane();
        Font tabbedPane_MainFont = this.$$$getFont$$$("JetBrains Mono NL", Font.BOLD, -1, tabbedPane_Main.getFont());
        if (tabbedPane_MainFont != null) tabbedPane_Main.setFont(tabbedPane_MainFont);
        tabbedPane_Main.setRequestFocusEnabled(false);
        ...
        Font labelModelResistanceRACFont = this.$$$getFont$$$("JetBrains Mono NL", Font.BOLD, -1, labelModelResistanceRAC.getFont());
        if (labelModelResistanceRACFont != null) labelModelResistanceRAC.setFont(labelModelResistanceRACFont);
        ...
        Font ModelResistanceRDCFont = this.$$$getFont$$$("JetBrains Mono NL", Font.BOLD, -1, ModelResistanceRDC.getFont());
        if (ModelResistanceRDCFont != null) ModelResistanceRDC.setFont(ModelResistanceRDCFont);
        ...
        panelModelResistance.add(spacer3, new com.intellij.uiDesigner.core.GridConstraints(0, 1, 1, 1, com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER, com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL, com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_GROW, 1, null, new Dimension(35, 11), null, 0, false));
        ...
        Font labelModelValuesLBEADFont = this.$$$getFont$$$("JetBrains Mono NL", Font.BOLD, -1, labelModelValuesLBEAD.getFont());
        if (labelModelValuesLBEADFont != null) labelModelValuesLBEAD.setFont(labelModelValuesLBEADFont);
        ...
        Font labelModelValuesCPARFont = this.$$$getFont$$$("JetBrains Mono NL", Font.BOLD, -1, labelModelValuesCPAR.getFont());
        if (labelModelValuesCPARFont != null) labelModelValuesCPAR.setFont(labelModelValuesCPARFont);
        ...
        textFieldModelValuesCPAR.setEditable(false);
        ...
        textFieldModelValuesLBEAD.setEditable(false);
        ...
        comboBoxModelValuesLBEAD.setEnabled(false);
        ...
        comboBoxModelValuesCPAR.setEnabled(false);
        ...
        panelModelValues.add(spacer5, new com.intellij.uiDesigner.core.GridConstraints(0, 1, 1, 1, com.intellij.uiDesigner.core.GridConstraints.ANCHOR_CENTER, com.intellij.uiDesigner.core.GridConstraints.FILL_HORIZONTAL, com.intellij.uiDesigner.core.GridConstraints.SIZEPOLICY_CAN_GROW, 1, null, new Dimension(19, -1), null, 0, false));
        ...
        Font labelModelReactancesFXCFont = this.$$$getFont$$$("JetBrains Mono NL", Font.BOLD, -1, labelModelReactancesFXC.getFont());
        if (labelModelReactancesFXCFont != null) labelModelReactancesFXC.setFont(labelModelReactancesFXCFont);
        ...
        Font labelModelReactancesXCFont = this.$$$getFont$$$("JetBrains Mono NL", Font.BOLD, -1, labelModelReactancesXC.getFont());
        if (labelModelReactancesXCFont != null) labelModelReactancesXC.setFont(labelModelReactancesXCFont);
        ...
        Font labelModelReactancesFXLFont = this.$$$getFont$$$("JetBrains Mono NL", Font.BOLD, -1, labelModelReactancesFXL.getFont());
        if (labelModelReactancesFXLFont != null) labelModelReactancesFXL.setFont(labelModelReactancesFXLFont);
        ...
        Font labelModelReactancesXLFont = this.$$$getFont$$$("JetBrains Mono NL", Font.BOLD, -1, labelModelReactancesXL.getFont());
        if (labelModelReactancesXLFont != null) labelModelReactancesXL.setFont(labelModelReactancesXLFont);
        ...
        Font labelDampingLCValuesLBEADFont = this.$$$getFont$$$("JetBrains Mono NL", Font.BOLD, -1, labelDampingLCValuesLBEAD.getFont());
        if (labelDampingLCValuesLBEADFont != null) labelDampingLCValuesLBEAD.setFont(labelDampingLCValuesLBEADFont);
        ...
        Font labelDampingLCValuesCDECOUPFont = this.$$$getFont$$$("JetBrains Mono NL", Font.BOLD, -1, labelDampingLCValuesCDECOUP.getFont());
        if (labelDampingLCValuesCDECOUPFont != null)
            labelDampingLCValuesCDECOUP.setFont(labelDampingLCValuesCDECOUPFont);
        ...
        textFieldDampingLCValuesLBEAD.setEditable(false);
        ...
        comboBoxDampingLCValuesLBEAD.setEnabled(false);
        ...
        Font labelDampingLCValuesCDAMPFont = this.$$$getFont$$$("JetBrains Mono NL", Font.BOLD, -1, labelDampingLCValuesCDAMP.getFont());
        if (labelDampingLCValuesCDAMPFont != null) labelDampingLCValuesCDAMP.setFont(labelDampingLCValuesCDAMPFont);
        ...
        lablel = new JLabel();
        Font lablelFont = this.$$$getFont$$$("JetBrains Mono NL", Font.BOLD, -1, lablel.getFont());
        if (lablelFont != null) lablel.setFont(lablelFont);
        ...
        textFieldDampingResistorsRMax.setEditable(false);
        ...
        Font labelDampingResistorsRMinFont = this.$$$getFont$$$("JetBrains Mono NL", Font.BOLD, -1, labelDampingResistorsRMin.getFont());
        if (labelDampingResistorsRMinFont != null) labelDampingResistorsRMin.setFont(labelDampingResistorsRMinFont);
        ...
        textFieldDampingResistorsRmin.setEditable(false);
